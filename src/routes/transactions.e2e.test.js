...
describe('Transaction Routes E2E Tests', () => {
    ...
    it('GET /api/transactions?userId should return 200 when fetching transaction succesfully', async () => {
        const { body: createdUser } = await request(app)
            .post('/api/users')
            .send({
                id: undefined,
    ...
    it('GET /api/transactions/:transactionId should return 200 when updating transaction succesfully', async () => {
        const { body: createdUser } = await request(app)
            .post('/api/users')
            .send({
                id: undefined,
    ...
    it('DELETE /api/transactions/:transactionId should return 200 when deleting transaction succesfully', async () => {
        const { body: createdUser } = await request(app)
            .post('/api/users')
            .send({
                id: undefined,
    ...
    it('DELETE /api/transactions/:transactionId should return 404 when updating a non-existing transaction', async () => {
        const response = await request(app).delete(
    ...
    it('GET /api/transaction?userId should return 404 when fetching from a non-existing transaction', async () => {
        const response = await request(app).get(
